...
/**
 * Stand-alone main program for executing the <em>Example 2 - Hello
 * World</em>. This example demonstrate following:
 * 
 * <ol>
 * <li>Spring Framework Maven Dependency Configuration</li>
 * <li>Basic example of XML based configuration of spring application.
 * </li>
...
public class Example2 {
    ...
    public static void main(final String[] args) {
         ...
         * of MessagePrinter.
         */
        final MessagePrinter printer = (MessagePrinter) context.getBean("messagePrinter");
