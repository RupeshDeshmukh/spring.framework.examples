...
import net.atos.spring.training.example14.dao.EmployeeDAO;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public List<Employee> findEmployeesBySearchCriteria(final EmployeeSearch employeeSearch) {
        ...
        LOGGER.info("Searching employees for the search criteria: " + employeeSearch.toString());

        return this.getEmployeDAO().findEmployeesBySearchCriteria(employeeSearch);
    }
