 ...
 * Copyright: 2016, Atos.
 */
package net.atos.spring.training.example14.dto;
...
public class EmployeeSearch implements Serializable {
    ...
    public String toString() {
        return "EmployeeSearch [firstName=" + firstName + ", lastName=" + lastName + ", salaryCode=" + salaryCode + ", emailAddress=" + emailAddress
