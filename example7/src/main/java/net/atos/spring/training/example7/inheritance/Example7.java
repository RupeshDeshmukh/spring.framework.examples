...
/**
 * Stand-alone main program for executing the <em>Example 7 - Hello
 * World & India</em>. This example demonstrate Bean Definition Inheritance.
 * 
...
public class Example7 {
    ...
    public static void main(final String[] args) {
        ...
        final HelloIndia helloIndia = (HelloIndia) context.getBean("helloIndia");
